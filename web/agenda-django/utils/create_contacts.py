...
if __name__ == '__main__':
    ...
    #Contact.objects.all().delete() #CAUTION
    #Category.objects.all().delete() #CAUTION

    fake = faker.Faker('en_US')
    categories = ['Friends', 'Family', 'Work']

    django_categories = [Category(category_name=category_name) for category_name in categories]
